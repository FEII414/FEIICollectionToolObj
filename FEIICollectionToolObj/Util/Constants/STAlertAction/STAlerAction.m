...
#import "STAlerAction.h"
#import <UIKit/UIKit.h>
#import "UIAlertView+STAlerAction.h"
#import "UIActionSheet+STAlerAction.h"

@implementation STAlerAction
...
+ (void)showAlertWithTitle:(NSString*)title msg:(NSString*)message chooseBlock:(void (^)(NSInteger buttonIdx))block  buttonsStatement:(NSString*)cancelString, ...
{
    ...
    if ( [STAlerAction isIosVersion8AndAfter])
    {
        ...
        [[STAlerAction getTopViewController] presentViewController:alertController animated:YES completion:nil];
