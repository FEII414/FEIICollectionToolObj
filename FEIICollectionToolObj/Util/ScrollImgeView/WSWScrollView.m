...
//提供数据源
- (void)addImagesArray:(NSMutableArray *)imagesArray centerItemFrame:(CGRect)centerItemFrame currentImageClick:(CurrentImageClick)currentImageClickBlock
{
...
- (void)rollImages
{
//    NSLog(@"interval---%f",_timeInterval);
